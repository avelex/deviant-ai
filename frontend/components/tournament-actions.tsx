  ...
  return (
    <div className="flex flex-row items-center gap-8 mb-8">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 bg-[#00E5FF] text-black px-6 py-3 text-[11px] font-bold tracking-widest uppercase hover:bg-[#00E5FF]/90 transition-all hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] whitespace-nowrap mt-1"
      >
        <Plus size={16} />
